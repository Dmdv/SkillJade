...
namespace DataAccess.Helpers
{
	public static class Guard
	{
			...
			where TException : Exception
		{
			if (data == null)
			{
				throw CreateNotNullException(exceptionCreator);
			}
		}
		...
		public static T GetNotNull<T, TException>(T? data, Func<TException> exceptionCreator)
			...
			where TException : Exception
		{
			CheckNotNull(data, () => CreateNotNullException(exceptionCreator));
		...
		/// <summary>
		/// Checks collection contains elemetns 
		...
		public static void CheckNotEmpty<T>(IEnumerable<T> collection, string message) where T : class
		{
			CheckNotNull(collection, "collection");
			CheckContainsText(message, "message");
		...
		private static TException CreateNotNullException<TException>(Func<TException> exceptionCreator)
			where TException : Exception
		{
